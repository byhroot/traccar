...
public class Takiponr12ProtocolEncoder extends BaseProtocolEncoder {

    public Takiponr12ProtocolEncoder(Protocol protocol) {
        super(protocol);
    }
    ...
    private ByteBuf encodeContent(long deviceId, String content) {
        ...
        buf.writeByte(Takiponr12ProtocolDecoder.MSG_COMMAND_0);
